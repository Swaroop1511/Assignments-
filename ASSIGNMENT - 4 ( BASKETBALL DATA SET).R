...
#Seasons of the players
Seasons <- c("2005","2006","2007","2008","2009","2010","2011",
             "2012","2013","2014")
...
rm(KobeBryant_G, JoeJohnson_G, CarmeloAnthony_G, DwightHoward_G, 
   ChrisBosh_G, LeBronJames_G, ChrisPaul_G, DerrickRose_G, 
...
# Number of free throws in Matrix
free_throws <- rbind(KobeBryant_FT, JoeJohnson_FT, LeBronJames_FT,
...
#Matrix
free_throws_attempts <- rbind(KobeBryant_FTA, JoeJohnson_FTA, LeBronJames_FTA, 
                              CarmeloAnthony_FTA, DwightHoward_FTA, ChrisBosh_FTA, ChrisPaul_FTA, KevinDurant_FTA, DerrickRose_FTA, DwayneWade_FTA)
rm(KobeBryant_FTA, JoeJohnson_FTA, LeBronJames_FTA, CarmeloAnthony_FTA, 
   DwightHoward_FTA, ChrisBosh_FTA, ChrisPaul_FTA, KevinDurant_FTA, DerrickRose_FTA, DwayneWade_FTA)
...
legend("topright",inset=0.01,legend=Players,col=c(1:10,2),
       pch=(10:15),horiz=FALSE, ncol = 2,cex = 0.3)
...
legend("topright",inset=0.01,legend=Players,col=c(1:10,2),pch=(10:15),
       horiz=FALSE, 
       ncol = 2,cex = 0.3)
